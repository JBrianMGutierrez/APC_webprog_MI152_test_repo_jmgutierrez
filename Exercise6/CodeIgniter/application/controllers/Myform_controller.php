...
class Myform_controller extends CI_Controller
{
    ...
    function index()
    {
        $data['myinput2'] = $this->Myform_model->get_all_myinput();

        $this->load->view('myform/index',$data);
    }
    ...
    {   
        ...
        {   
            ...
            $myinput2_id = $this->Myform_model->add_myinput($params);
            redirect('myform_controller/index');
        }
        else
        {
            $this->load->view('myform/add');
        }
    }
	function edit($id)
    {   
        ...
        if(isset($myinput2['id']))
        {
            ...
            {   
                $data['myinput2'] = $this->Myreadeditdelete_model->get_myinput($id);
    
                $this->load->view('myreadeditdelete_view/edit',$data);
            }
        }
        else
            show_error('The myinput you are trying to edit does not exist.');
    } 
