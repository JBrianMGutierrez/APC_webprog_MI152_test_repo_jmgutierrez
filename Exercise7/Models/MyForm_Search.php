...
/**
 * MyForm_Search represents the model behind the search form about `app\models\MyForm_Model`.
 */
class MyForm_Search extends MyForm_Model
{
    /**
     * @inheritdoc
     */
